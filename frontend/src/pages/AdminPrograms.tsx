  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-ink font-heading">Programas Académicos</h2>
          <p className="text-sm mt-0.5 text-ink-secondary">Administra los programas académicos para vacantes y perfiles.</p>
        </div>
      </div>
