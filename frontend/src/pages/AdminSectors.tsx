  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-ink font-heading">Sectores Empresariales</h2>
          <p className="text-sm mt-0.5 text-ink-secondary">Administra los sectores que las empresas pueden elegir.</p>
        </div>
      </div>
